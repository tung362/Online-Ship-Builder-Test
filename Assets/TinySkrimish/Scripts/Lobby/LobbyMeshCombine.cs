...
public class LobbyMeshCombine : TungDoesMathForYou
{
    /*Settings*/
    ...
    public void CombineMeshes()
    {
        ...
        for (int i = 0; i < finalCombiners.Count; i++)
        {
            ...
            else
            {
                ...
                chunk.AddComponent<LobbyColorChange>();
                ...
                chunk.GetComponent<LobbyColorChange>().ID = ID;
                AllChunks.Add(chunk);
        ...
        finalChunk.AddComponent<LobbyColorChange>();
        ...
        finalChunk.GetComponent<LobbyColorChange>().ID = ID;
